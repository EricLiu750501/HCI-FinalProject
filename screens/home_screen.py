...
class HomeScreen(BaseScreen):
    ...
    def draw(self, frame):
        ...
        cv2.rectangle(frame, (right_panel_x, 0), 
        ...
        for i, text in enumerate(BUTTONS):
            ...
            draw_button(frame, text, ICONS[i], (x, y), 
                       (button_width, button_height), 
                       selected=False, hover=hover)
        ...
        draw_button(frame, "Exit", "assets/icons/icon_exit.png",
                   (exit_x, exit_y), 
                   (button_width, button_height//2),
                   selected=False, hover=False)
        self.button_areas.append((exit_x, exit_y, 
                                exit_x + button_width,
                                exit_y + button_height//2))
