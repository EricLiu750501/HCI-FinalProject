...
class PerformJutsuScreen(BaseScreen):
    ...
    def set_jutsu(self, jutsu):
        ...
        self.gesture_labels = [{"g_name_zh": None, "g_name_en": None}]
    ...
    def draw(self, frame):
        ...
        CvDrawText.puttext(
            frame,
            f"施展招式: {self.cur_jutsu['name_zh']} 吧!",
            (15, 15),
            self.font_path,
            40,
            color=(255, 255, 255),
        ...
        if ret:
            ...
            frame[100 : 100 + 480, 20 : 20 + 640] = cv2.resize(image, (640, 480))
            ...
            if result_id == self.cur_jutsu["sequence"][self.cur_sequence_i]:
                if not self.progressing:
                    ...
                    progress = min(
                        100, int((elapsed_time / self.PROGRESS_DURATION) * 100)
                    )
    ...
    def __draw_hint_image(self, frame):
        ...
        if os.path.exists(gesture_img_path):
            ...
            if gesture_img is not None:
                ...
                frame[100 : 100 + 398, 720 : 720 + 530] = gesture_img
    ...
    def __draw_buttons(self, frame):
        ...
        # draw back button
        back_x, back_y = WINDOW_SIZE[0] - 200, WINDOW_SIZE[1] - 80
    ...
    def __find_gesture_id_in_cam(self, image):
        ...
        boxes, scores, g_ids = self.yolox.inference(image)
